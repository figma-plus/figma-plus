	...
	var e = {
			...
			methods: {
				...
				changeTab: function(t, e, i) {
					...
					n.disabled ||
						...
						this.$emit('tab-change', e, n, a),
						this.tryChangeRoute(i));
				},
				...
				findTabAndActivate: function(i) {
					var t = this.tabs.findIndex(function(t, e) {
						return t.title === i || e === i;
					});
				...
				renderTabTitle: function(t) {
					...
					if (0 !== this.tabs.length) {
						...
						'center' === e && (o.color = this.activeTextColor);
						var r = i('span', { class: 'title title_' + e, style: n ? o : {} }, [
							'center' === e && this.renderIcon(t),
							s
						]);
						return a.$slots.title
							? a.$slots.title
							: a.$scopedSlots.title
							? a.$scopedSlots.title({ active: n, title: s, position: e, icon: a.icon, data: a.tabData })
							: r;
					}
				},
				renderIcon: function(t) {
					...
					if (0 !== this.tabs.length) {
						var i = this.tabs[t],
							a = i.icon,
							n = e('i', { class: a }, [' ']);
						return !i.$slots.title && a ? n : void 0;
					}
				},
				...
				renderTabs: function() {
					...
					return this.tabs.map(function(n, s) {
						if (n) {
							var o = n.route,
								t = (n.id, n.title),
								e = (n.icon, n.tabId),
								i = r.activeTabIndex === s,
								a = r.activeTabIndex === s + 1;
							return c(
								'li',
								[
									{
										attrs: { name: 'tab', id: 't-' + e, 'aria-selected': i, 'aria-controls': 'p-' + e, role: 'tab' },
										class: ['modal-tab', { active: i }, { disabled: n.disabled }, { leftOfActive: a }],
										key: t
									},
									{
										on: {
											click: function(t) {
												for (var e = arguments.length, i = Array(1 < e ? e - 1 : 0), a = 1; a < e; a++)
													i[a - 1] = arguments[a];
												(function() {
													return !n.disabled && r.navigateToTab(s, o);
									...
									var i, a, n, s, o;
									for (n in e)
										if (((i = t[n]), (a = e[n]), i && l.test(n)))
											if (
												('class' === n &&
													('string' == typeof i && ((o = i), (t[n] = i = {}), (i[o] = !0)),
													'string' == typeof a && ((o = a), (e[n] = a = {}), (a[o] = !0))),
												'on' === n || 'nativeOn' === n || 'hook' === n)
											)
												for (s in a) i[s] = d(i[s], a[s]);
											else if (Array.isArray(i)) t[n] = i.concat(a);
											else if (Array.isArray(a)) t[n] = [i].concat(a);
											else for (s in a) i[s] = a[s];
										else t[n] = e[n];
									return t;
								}, {}),
								['center' === r.textPosition && r.renderTabTitle(s, r.textPosition)]
							);
						}
					});
				}
			...
			render: function() {
				...
				return t('div', { class: ['vue-tabs', this.stackedClass] }, [
					t('div', { class: [{ 'nav-tabs-navigation': !this.isStacked }, { 'left-vertical-tabs': this.isStacked }] }, [
						t('div', { class: ['nav-tabs-wrapper', this.stackedClass] }, [
							t('ul', { class: this.classList, attrs: { role: 'tablist' } }, [e])
						])
					]),
					t('div', { class: [{ 'right-text-tabs': this.isStacked }] }, [this.$slots.default])
				]);
			},
			watch: {
				tabs: function(t) {
					0 < t.length &&
						...
						0 < t.length && this.value && this.findTabAndActivate(this.value);
				},
				value: function(t) {
		...
		a = {
			install: function(t) {
				t.component('vue-tabs', e), t.component('v-tab', i);
			}
		};
	'undefined' != typeof window && window.Vue && (window.Vue.use(a), (window.VueTabs = a)),
		(t.default = a),
		(t.VueTabs = e),
		(t.VTab = i),
